sample = '''
		<elementProp name="siteurlnum_%(num)s" elementType="Argument">
            <stringProp name="Argument.name">siteurlnum_%(num)s</stringProp>
            <stringProp name="Argument.value">http://atperf/sites/toplevelsite%(user_num)s/</stringProp>
            <stringProp name="Argument.metadata">=</stringProp>
        </elementProp>
          <elementProp name="state_busy_%(num)s" elementType="Argument">
            <stringProp name="Argument.name">state_busy_%(num)s</stringProp>
            <stringProp name="Argument.value">true</stringProp>
            <stringProp name="Argument.metadata">=</stringProp>
          </elementProp>
          <elementProp name="curr_actual_on_%(num)s" elementType="Argument">
            <stringProp name="Argument.name">curr_actual_on__%(num)s</stringProp>
            <stringProp name="Argument.value">0</stringProp>
            <stringProp name="Argument.metadata">=</stringProp>
          </elementProp>
          <elementProp name="user_%(user_num)s" elementType="Argument">
            <stringProp name="Argument.name">user_%(user_num)s</stringProp>
            <stringProp name="Argument.value">ford_user%(user_num)s</stringProp>
            <stringProp name="Argument.metadata">=</stringProp>
          </elementProp>		  
      ...
      <hashTree>
        ...
        <hashTree>
          <ConstantTimer guiclass="ConstantTimerGui" testclass="ConstantTimer" testname="Constant Timer" enabled="true">
            <stringProp name="ConstantTimer.delay">%(rumpUpDelay)s</stringProp>
          </ConstantTimer>
          <hashTree/>
        </hashTree>
            ...
            <AuthManager guiclass="AuthPanel" testclass="AuthManager" testname="HTTP Authorization Manager" enabled="true">
              <collectionProp name="AuthManager.auth_list">
                <elementProp name="" elementType="Authorization">
                  ...
                  <stringProp name="Authorization.username">${user_%(user_num)s}</stringProp>
...
for i in range(200):
	res += sample2 % { 'num': i+1, 'user_num': i, "rumpUpDelay" : i*3000 } + '\n'
